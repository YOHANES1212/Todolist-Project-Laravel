...
@section('title', 'My Tasks - YukKerjain!')
...
@section('content')
    <div class="flex justify-between items-center border-b-2 border-[#ff6b6b] pb-[15px] mb-[30px]">
        <h1 id="page-title" class="text-[#333] text-2xl">My Tasks</h1>
        ...
        <div class="flex-1 bg-white rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-10" id="left-panel" style="overflow-y: auto;">
            ...
            @empty
                <div class="w-full h-full flex flex-col items-center justify-center text-center">
                    <i class="fas fa-tasks text-6xl text-[#eaeaea] mb-5"></i>
                    <div class="text-lg font-semibold text-[#a0a0a0] mb-2.5">Tidak ada tugas baru!</div>
                    <div class="text-sm text-[#c0c0c0]">Klik tombol + untuk menambah tugas</div>
                </div>
            @endforelse
